...
![Vista general arquitectura limpia]({{ '/images/backend/Untitled.png' | relative_url }})
...
![Diagrama detallado de la arquitectura]({{ '/images/backend/Untitled%202.png' | relative_url }})
