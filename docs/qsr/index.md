...
1. **[🏗️ Pipelines de Producción](pipelines-produccion.md)** - Conoce todos los pipelines disponibles
2. **[🚀 Proceso de Deploy](proceso-deploy.md)** - Aprende el procedimiento paso a paso
3. **[✅ Checklist QSR](checklist-qsr.md)** - Ejecuta con lista de verificación
4. **[🚨 Troubleshooting](troubleshooting-produccion.md)** - Resuelve problemas comunes
5. **[📄 QSR-2666059 Reference](qsr-2666059-reference.md)** - Consulta la referencia específica
...
- [🏛️ Arquitectura Backend](/docs/arquitectura/) - Diseño del sistema
- [⚙️ Backend - APIs](/docs/backend/) - Servicios disponibles
- [🔄 CI/CD](/docs/cicd/) - Pipelines de desarrollo
- [🐳 Docker y AWS](/docs/cicd/docker-aws.md) - Infraestructura

### Configuración y Referencias

- [🔧 Variables de Entorno](/docs/general/variables_entorno.md)
- [📝 Enums](/docs/general/enums.md)
