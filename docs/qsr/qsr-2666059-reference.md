...
**Archivo**: `{{ '/files/qsr/QSR-2666059 - CICDQSRPipelinesInstructions_toDeploy.docx' | relative_url }}`
...
**Archivo**: `{{ '/files/qsr/QSR-2666059 - Test Script-Pipeline.docx' | relative_url }}`
...
- [📄 Archivos QSR Originales]({{ '/files/qsr/' | relative_url }}) - Documentos Word fuente
